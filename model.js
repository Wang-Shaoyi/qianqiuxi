...
COMBO_LIST  = [
  ...
  [['百里屠苏','阿翔','乐无异','馋鸡','北洛','原天柿'],'携宠同行',60,'dlbs',1567.347]/*
...
class Model {
  ...
  setPack(packs){
    this.pack = packs;
    for(var i=COMBO_LIST.length-1; i>=0; i--)
      if(COMBO_LIST[i][1] == "古剑奇谭")
        COMBO_LIST.splice(i, 1);

    var packCombos = {
      "12": [['昭明','无名之剑','古剑焚寂','古剑红玉','古剑晗光'],'古剑奇谭',40,'gjqt',2429.388],
      "13": [['古剑红玉','古剑焚寂','天鹿','太岁'],'古剑奇谭',30,'gjqt',2429.388],
      "23": [['昭明','无名之剑','古剑晗光','天鹿','太岁'],'古剑奇谭',40,'gjqt',2429.388],
      "123": [['昭明','无名之剑','古剑焚寂','古剑红玉','古剑晗光','天鹿','太岁'],'古剑奇谭',80,'gjqt',2429.388]
    };
    COMBO_LIST.push(packCombos[packs.join("")]);
  }
  init(){
